...
class TestBottles < Minitest::Test
  def test_verse_99
    bottles = Bottles.new
    assert_equal("99 bottles of beer on the wall, 99 bottles of beer. Take one down, pass it around, 98 bottles of beer on the wall.", bottles.verse(99))
  end

  def test_verse_98
    bottles = Bottles.new
    assert_equal("98 bottles of beer on the wall, 98 bottles of beer. Take one down, pass it around, 97 bottles of beer on the wall.", bottles.verse(98))
  end

  def test_verse_2
    bottles = Bottles.new
    assert_equal("2 bottles of beer on the wall, 2 bottles of beer. Take one down, pass it around, 1 bottle of beer on the wall.", bottles.verse(2))
  end

  def test_verse_1
    bottles = Bottles.new
    assert_equal("1 bottle of beer on the wall, 1 bottle of beer. Take one down, pass it around, no more bottles of beer on the wall.", bottles.verse(1))
  end

  def test_verse_0
    bottles = Bottles.new
    assert_equal("No more bottles of beer on the wall, no more bottles of beer. Go to the store, get some more, 99 bottles of beer on the wall.", bottles.verse(0))
  end

  def test_song
    bottles = Bottles.new
    assert_equal("99 bottles of beer on the wall, 99 bottles of beer. Take one down, pass it around, 98 bottles of beer on the wall.
...
No more bottles of beer on the wall, no more bottles of beer. Go to the store, get some more, 99 bottles of beer on the wall.", bottles.song)
  end
end
